(function (global) 
{
    ...
    function WidgetTextSwitcher(element, options) {
    ...
    if (typeof define === "function" && define.amd) {
      define(function () {
        return WidgetTextSwitcher;
      });
    } else if (typeof module === "object" && module.exports) {
      module.exports = WidgetTextSwitcher;
    } else {
      global.WidgetTextSwitcher = WidgetTextSwitcher;
    }
    ...
    var WidgetRegistry = {
        name: "WidgetTextSwitcher",
        init: function () {
          var components = document.getElementsByTagName("WidgetTextSwitcher");
